...
There are 60 pre-made levels for this game. Twenty 3x3, twenty 4x4, and twenty 5x5. Some are manually created and some are created with the random level generator. 

Manual Level data was generated by using the built game board and turning on/off lights at specific indices to create a pattern. This data was kept in the LevelData object and saved to disk as a .json. This allowed for a high level of control and ensured levels were solvable. Once could also generate unique patterns for cool looking levels. 

A level generator was also created to assist with level creation. 
